      ...
      <CommentThread onPost={(commentText) => this.handleCommentPost(commentText)}>
        {
          ...
          return (
          <Comment key={i} author={comment.author} data ={comment} feedKey ={this.state._id} likeCounter={comment.likeCounter} index ={i} postDate={comment.postDate}> {comment.contents}
          </Comment>
          );
          })
        }
